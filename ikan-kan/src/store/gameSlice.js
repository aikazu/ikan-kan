...
export const gameSlice = createSlice({
  ...
  reducers: {
    ...
    resetGame: () => {
      // Return a new copy of the initial state, ensuring all fields are reset.
      // Specific overrides can be done here if a field's reset value differs from its initial value.
      return {
        ...initialState,
        // Ensure nested objects are also new copies if they were potentially mutated from the original initialState import
        upgrades: { ...initialState.upgrades }, 
        researchedItems: { ...initialState.researchedItems },
        discoveredFish: { ...initialState.discoveredFish }, 
...
// Selectors // MOVED TO gameSelectors.js
